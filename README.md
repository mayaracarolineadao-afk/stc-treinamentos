...
A STC – Semensato Treinamentos Corporativos oferece treinamento especializado em Segurança do Trabalho com foco na NR-01, atendendo às exigências legais e promovendo uma cultura organizacional voltada à prevenção, responsabilidade e gestão de riscos.

Nosso treinamento é desenvolvido para capacitar empregadores, gestores e colaboradores quanto aos direitos, deveres e responsabilidades previstos na Norma Regulamentadora nº 01, com ênfase no Gerenciamento de Riscos Ocupacionais (GRO) e na correta implementação do PGR.

🎯 Objetivos do treinamento

Garantir conformidade legal com a NR-01

Reduzir riscos de acidentes e passivos trabalhistas

Fortalecer a cultura de prevenção e segurança

Capacitar equipes para identificar, avaliar e controlar riscos

📚 Conteúdo

Fundamentos da NR-01
...
Integração da NR-01 com demais NRs
